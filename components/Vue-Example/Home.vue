...
<template>
  <div class="container">
    ...
    <div>=============================================================</div>
    <div>Truyền data từ con sang cha</div>
    <div>hiện ở Cha: {{ dataShareChild }}</div>
    <TagSelector
      :dataShareChild="dataShareChild"
      @dataShareUpdate="dataUpdateShareFromChild"
    />
...
export default {
  ...
  created() {
    ...
    //thường dùng khởi tạo websocket, lắng nghe event Laravel Echo,... miễn là ta không động gì vào DOM thật là được
  },
  ...
  mounted() {
    ...
    //thường dùng để gọi API lấy dữ liệu từ server
    console.log("HERE");
  },
  beforeUpdate: {
